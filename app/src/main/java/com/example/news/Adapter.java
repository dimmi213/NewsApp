...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.pulishedat.setText(modelArrayList.get(position).getPublishedAt()+"Source "+modelArrayList.get(position).getAuther());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView headlines, mainnews, auther, pulishedat;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            headlines = itemView.findViewById(R.id.mainHealines_id);
            mainnews = itemView.findViewById(R.id.newsdesciption_id);
